...
//
//     final adan = adanFromJson(jsonString);

import 'dart:convert';

Adan adanFromJson(String str) => Adan.fromJson(json.decode(str));

String adanToJson(Adan data) => json.encode(data.toJson());
...
class Adan {
    ...
    factory Adan.fromJson(Map<String, dynamic> json) => Adan(
        code: json["code"],
        status: json["status"],
